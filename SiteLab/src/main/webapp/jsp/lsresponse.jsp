<%-- 
    Document   : response
    Created on : Jul 7, 2016, 2:56:53 PM
    Author     : apprentice
--%>
        ...
        <div class="container">
            ...
            <div class="navbar">
                ...
                <div align='center'>
                    <h1>Lucky Sevens</h1>
                    <h3>Results</h3>
                    <c:out value="Starting bet: ${startingBet}" default="Don't you want to bet?"/>
                    <p><c:out value="You are broke after: ${maxRolls} rolls" /></p>
                    <p><c:out value="You should have quit after ${maxDollarRolls} rolls" />
                        <c:out value="when you had $${maxMoney}." /></p>
                    <h4><a href="${pageContext.request.contextPath}/luckyseven" class="button"> Play Again?</h4>
                </div>
            </div>
        </div>
    </body>
